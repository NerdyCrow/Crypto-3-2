...
let FIO = "Slemnyov Victor Nikolaevich";
let ascii = "";
...
console.log(`Amount of information (p=${mistake1}): ${amountFioInfoWithMistake("Slemnyov Victor Nikolaevich", bin_eS, mistake1)} bit`);
...
let english = "Slemnyov Victor Nikolaevich";
let russian = "Слемнёв Виктор Николаевич";
